...
<form class="form-horizontal" role="form" method="POST" action="?register">
	...
	<div align="center" id="vp" style="width:300px;margin-left:20px;">
	  ...
	  <font color="black">Pin code:</font><br>

	  <input type="text" name="pin" maxlenght="32" value="">

	  <br>

	  <font color="black">Captcha:</font>

	  <div style="display:block;margin-bottom:0px;margin-top:0px;">

	        <img src="image1170c.png">
